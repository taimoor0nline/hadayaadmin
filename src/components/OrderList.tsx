  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const mappedOrders: IMappedOrder[] = result.data.map((order: any) => ({
        ...
        isExpressDelivery: order.isExpressDelivery === true ? 'Yes' : 'No',
        orderNote: order.orderNote || 'N/A',
        isAddressNeededFromRcvr: order.isAddressNeededFromRcvr === true ? 'Yes' : 'No',
        isAddressUpdatedByRcvr: order.isAddressUpdatedByRcvr === true ? 'Yes' : 'No',
        keepIdentitySecret: order.keepIdentitySecret === true ? 'Yes' : 'No',
